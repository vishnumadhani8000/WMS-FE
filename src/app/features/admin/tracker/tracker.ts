import { Component, OnInit, ViewChild, DestroyRef, signal, computed } from '@angular/core';
...
export class Tracker implements OnInit {
  ...
  form = new FormGroup({
    ...
    cityControl: new FormControl<number | null>({
      value: null,
      disabled: true,
    }),
  });
  ...
  initializeFilterSubscriptions(): void {
